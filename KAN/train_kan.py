...
input = pd.read_csv('./KAN/data/train_input.csv', header=None)
target = pd.read_csv('./KAN/data/train_target.csv', header=None)
...
torch.save(model.state_dict(), "./KAN/model/kan.pth")
